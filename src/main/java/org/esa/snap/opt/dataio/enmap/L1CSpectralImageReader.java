...
public class L1CSpectralImageReader implements SpectralImageReader {

    private final GeoTiffImageReader spectralImageReader;

    public L1CSpectralImageReader(VirtualDir dataDir, EnmapMetadata meta) throws IOException {
